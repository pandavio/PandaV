...
public class b4xsearchtemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.pdv.b4xsearchtemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.pdv.b4xsearchtemplate.class).invoke(this, new Object[] {null});
        else
...
public com.pdv.b4xfloattextfield _searchfield = null;
...
_searchfield = new com.pdv.b4xfloattextfield();
...
__c.LogImpl("930408735","Index time: "+BA.NumberToString((__c.DateTime.getNow()-_starttime))+" ms ("+BA.NumberToString(_items.getSize())+" Items)",0);
...
public ResumableSub_Show(com.pdv.b4xsearchtemplate parent,com.pdv.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.pdv.b4xsearchtemplate parent;
