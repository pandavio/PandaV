...
public class b4xbytesbuilder extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.pdv.b4xbytesbuilder");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.pdv.b4xbytesbuilder.class).invoke(this, new Object[] {null});
        else
...
public com.pdv.b4xbytesbuilder  _append(byte[] _data) throws Exception{
...
public com.pdv.b4xbytesbuilder  _append2(byte[] _data,int _startindex,int _length) throws Exception{
int _oldlength = 0;
...
if (true) return (com.pdv.b4xbytesbuilder)(this);
...
if (_index>_mlength) { 
__c.LogImpl("95177346","Index too large",0);};
