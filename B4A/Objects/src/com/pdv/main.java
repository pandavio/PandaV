...
public class main extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.pdv", "com.pdv.main");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.pdv", "com.pdv.main");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.pdv.main", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._b4xpages._delegate /*com.pdv.b4xpagesdelegator*/ ._activity_actionbarhomeclick /*String*/ ();
...
if (true) return mostCurrent._b4xpages._delegate /*com.pdv.b4xpagesdelegator*/ ._activity_keypress /*boolean*/ (_keycode);
...
mostCurrent._b4xpages._delegate /*com.pdv.b4xpagesdelegator*/ ._activity_pause /*String*/ ();
...
mostCurrent._b4xpages._delegate /*com.pdv.b4xpagesdelegator*/ ._activity_permissionresult /*String*/ (_permission,_result);
 //BA.debugLineNum = 59;BA.debugLine="End Sub";
return "";
}
public static String  _activity_resume() throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Sub Activity_Resume";
 //BA.debugLineNum = 50;BA.debugLine="B4XPages.Delegate.Activity_Resume";
mostCurrent._b4xpages._delegate /*com.pdv.b4xpagesdelegator*/ ._activity_resume /*String*/ ();
...
mostCurrent._b4xpages._delegate /*com.pdv.b4xpagesdelegator*/ ._create_menu /*String*/ (_menu);
