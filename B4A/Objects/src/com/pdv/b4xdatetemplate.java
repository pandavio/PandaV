...
public class b4xdatetemplate extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.pdv.b4xdatetemplate");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.pdv.b4xdatetemplate.class).invoke(this, new Object[] {null});
        else
...
public ResumableSub_Show(com.pdv.b4xdatetemplate parent,com.pdv.b4xdialog _dialog) {
this.parent = parent;
this._dialog = _dialog;
}
com.pdv.b4xdatetemplate parent;
