...
public class b4xprogressdialog extends B4AClass.ImplB4AClass implements BA.SubDelegator{
    ...
    private void innerInitialize(BA _ba) throws Exception {
        if (ba == null) {
            ba = new BA(_ba, this, htSubs, "com.pdv.b4xprogressdialog");
            if (htSubs == null) {
        ...
        if (BA.isShellModeRuntimeCheck(ba)) 
			   this.getClass().getMethod("_class_globals", com.pdv.b4xprogressdialog.class).invoke(this, new Object[] {null});
        else
...
public com.pdv.b4xloadingindicator _loadingindicator = null;
public anywheresoftware.b4a.objects.B4XViewWrapper _label1 = null;
public com.pdv.b4xdialog _mdialog = null;
...
_loadingindicator = new com.pdv.b4xloadingindicator();
...
_mdialog = new com.pdv.b4xdialog();
...
public String  _show(com.pdv.b4xdialog _dialog) throws Exception{
...
if (BA.fastSubCompare(sub, "SHOW"))
	return _show((com.pdv.b4xdialog) args[0]);
